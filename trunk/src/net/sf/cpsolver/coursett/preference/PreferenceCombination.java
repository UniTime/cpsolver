...
public abstract class PreferenceCombination {
    ...
    public void addPreferenceInt(int intPref) {
        ...
        if (Constants.sPreferenceRequired.equals(prologPref)) iIsRequired = true;
        if (Constants.sPreferenceProhibited.equals(prologPref)) iIsProhibited = true;
    }
    ...
    public String getPreferenceProlog() {
    	if (iIsProhibited) return Constants.sPreferenceProhibited;
    	if (iIsRequired) return Constants.sPreferenceRequired;
