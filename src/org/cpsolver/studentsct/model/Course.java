...
public class Course extends AbstractClassWithContext<Request, Enrollment, Course.CourseContext>
        implements CanInheritContext<Request, Enrollment, Course.CourseContext> {
    private long iId = -1;
     ...
     * @param offering
     *                         instructional offering which is offered under this
     *                         course offering
     */
     ...
     * 
     * @param limit
     *                  course offering limit, -1 if unlimited
     **/
    ...
    /**
     * Enrollment weight -- weight of all requests that are enrolled into this
     * course, excluding the given one. See {@link Request#getWeight()}.
     * 
     * @param assignment
     *                           current assignment
    ...
    /**
     * Add request group of this course. This is automatically called by the
     * constructor of the {@link RequestGroup}.
     * 
     * @param group
     ...
     * 
     * @param credit
     *                   scheduling course credit
     */

    // made CourseCredit extracted class for all methods
    ...
    @Override
    public CourseContext inheritAssignmentContext(Assignment<Request, Enrollment> assignment,
    ...
    public class CourseContext implements AssignmentConstraintContext<Request, Enrollment> {
        ...
        public void assigned(Assignment<Request, Enrollment> assignment, Enrollment enrollment) {
            ...
            if (iEnrollments.add(enrollment)
                    && (enrollment.getReservation() == null || !enrollment.getReservation().canBatchAssignOverLimit()))
        ...
        public double getEnrollmentWeight(Assignment<Request, Enrollment> assignment, Request excludeRequest) {
            ...
            if (excludeRequest != null) {
                ...
                if (enrollment != null && iEnrollments.contains(enrollment) && (enrollment.getReservation() == null
                        || !enrollment.getReservation().canBatchAssignOverLimit()))
