 ...
 * 
 * Instead of holding the data directly, the class only holds a reference to the appropriate assignment context,
 * which is stored with the assignment and returned from the assignment using the reference.
 * 
 * @author  Tomas Muller
