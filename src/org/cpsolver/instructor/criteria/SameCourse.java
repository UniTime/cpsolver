...
/**
 * Same Course Preferences. This criterion counts how well are the same course preferences that are set on a {@link TeachingRequest} met
 * (counting {@link TeachingRequest#getSameCoursePenalty(TeachingRequest)}).
 * 
