...
/**
 * Teaching Preferences. This criterion counts how well are the teaching preferences that are set on an {@link Instructor} met
 * (counting {@link Instructor#getPreference()}).
 * 
 * @author  Tomas Muller
