...
public class RoomSharingModel {
    ...
    protected Hashtable iDepartmentIdx = null;
    ...
    public RoomSharingModel(Long[] managerIds, String pattern) {
        ...
        for (int i=0;i<managerIds.length;i++) {
            ...
            iDepartmentIdx.put(managerIds[i],new Integer(i));
        }
    ...
    public Long getDepartmentId(int day, int time) {
        ...
        if (pref.equals(sFreeForAllPref) || pref.equals(sNotAvailablePref)) return null;
        return pref;
    }
    ...
    public int getNrDays() { return Constants.NR_DAYS; }
    public int getNrTimes() { return Constants.SLOTS_PER_DAY/6; }
}
