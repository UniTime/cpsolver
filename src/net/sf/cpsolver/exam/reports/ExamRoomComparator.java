 ...
 * alternative sating size is used, based on the given exam (see
 * {@link Exam#hasAltSeating()}. 
 * <br><br>
 * 
 * @version
 ...
 */
public class ExamRoomComparator implements Comparator {
    private boolean iAsc;
    private Exam iExam;
    
    /**
     * Constructor
     * @param exam exam for which rooms are to be compared
     */
